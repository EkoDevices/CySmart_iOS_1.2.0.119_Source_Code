...
/*!
 *  @class CharacteristicListTableViewCell
 *
 *  @discussion Class to handle the cell operations in characteristic list
 *
 */
@implementation CharacteristicListTableViewCell
{
    /* Datafields */
    __weak IBOutlet UILabel *characteristicPropertiesLabel;
}
- (void)awakeFromNib {
    // Initialization code
}
...
/*!
 *  @method setCharacteristicName: andProperties:
 *
 *  @discussion Method to display characteristic name and properties in cell
 *
 */
