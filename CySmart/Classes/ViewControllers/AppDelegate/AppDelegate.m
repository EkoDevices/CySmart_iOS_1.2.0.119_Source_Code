...
-(BOOL)application:(UIApplication *)application openURL:(NSURL *)url sourceApplication:(NSString *)sourceApplication annotation:(id)annotation
{
    ...
    {
        UIAlertView * copyFileAlert = [[UIAlertView alloc] initWithTitle:APP_NAME message:LOCALIZEDSTRING(@"fileReplaceAlert") delegate:self cancelButtonTitle:@"No" otherButtonTitles:@"Yes", nil];
        copyFileAlert.tag = FILE_COPY_ALERT_TAG;
        [copyFileAlert show];
    }
...
-(void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex{
    if (FILE_COPY_ALERT_TAG == alertView.tag)
    {
        NSFileManager * fileManager = [NSFileManager defaultManager];
